<form wire:submit.prevent="submit_comment()" accept-charset="UTF-8">
    ...
    <button class="font-bold py-2 px-4  bg-gray-500 text-white shadow-md rounded-lg ">Comment </button>
</form>
